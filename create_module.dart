...
void main(List<String> args) {
  ...
  final baseDir = 'lib/modules/$moduleName';
  ...
  final pascalCaseName = moduleName
      .split('_')
      .map((word) {
  ...
  final files = {
    '$baseDir/api/api_client/${moduleName}_api_client.dart':
        '''
import 'package:dio/dio.dart';
import 'package:injectable/injectable.dart';
import 'package:retrofit/retrofit.dart';

part '${moduleName}_api_client.g.dart';
...
''',
    '$baseDir/api/datasources/${moduleName}_remote_data_source_impl.dart':
        '''
import 'package:injectable/injectable.dart';
import '../../data/datasources/${moduleName}_remote_data_source.dart';
...
''',
    '$baseDir/data/datasources/${moduleName}_remote_data_source.dart':
        '''
abstract class ${pascalCaseName}RemoteDataSource {
  // TODO: Implement
}
''',
    '$baseDir/data/repositories/${moduleName}_repo_impl.dart':
        '''
import 'package:injectable/injectable.dart';
import '../../domain/repositories/${moduleName}_repo.dart';
...
''',
    '$baseDir/domain/repositories/${moduleName}_repo.dart':
        '''
abstract class ${pascalCaseName}Repo {
  // TODO: Implement
}
''',
    '$baseDir/presentation/cubit/${moduleName}_event.dart':
        '''
abstract class ${pascalCaseName}Event {}
''',
    '$baseDir/presentation/cubit/${moduleName}_state.dart':
        '''
abstract class ${pascalCaseName}State {}
class ${pascalCaseName}Initial extends ${pascalCaseName}State {}
''',
    '$baseDir/presentation/cubit/${moduleName}_cubit.dart':
        '''
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:injectable/injectable.dart';
import '${moduleName}_event.dart';
import '${moduleName}_state.dart';
...
''',
    '$baseDir/presentation/pages/${moduleName}_page.dart':
        '''
...
''',
  ...
  print(
    '\\nModule architecture and files for "$moduleName" created successfully!',
  );
}
